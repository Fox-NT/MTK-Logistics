...
<head>
    ...
    <script src="https://api-maps.yandex.ru/2.1/?apikey=d3c0c45e-37d5-4896-bdec-8c90c50e3fa3&lang=ru_RU" type="text/javascript">
    </script>
                ...
                <div class="header__wrapper">
                    ...
                    <div class="header__nav menu mobile-menu">
                        ...
                        <div class="header__contacts contacts mobile-contacts">
                            <div class="contacts__phone"><a href="tel:<?php the_field('header__phone_dig', 'options'); ?>"><?php the_field('header__phone', 'options'); ?></a> </div>
...
', 'options'); ?></div>
                ...
                <form id="form-feed" class="form" action="/">
                    <div class="feedback__field">
                        ...
                        <input class="phone-mask" id="phone" name="phone" type="tel" placeholder="+7 (___) ___ __ __">
                    </div>
